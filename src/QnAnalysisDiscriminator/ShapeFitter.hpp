...
public:
  ...
  TF1* GetFuncSgnl() const { return func_sgnl_.first; };
  ...
  std::pair<TF1*, TMatrixDSym*> FitSgnl(TH1F* histo, float left, float right) const;           // TODO move to private after debugging
...
private:
  ...
  std::pair<TF1*, TMatrixDSym*> func_sgnl_{nullptr, nullptr};
